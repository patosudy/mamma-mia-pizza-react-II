                        ...
                        <div key={pizza.id} className="col-lg-4 mb-4">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <button className="btn btn-outline-success btn-sm" onClick={() => pizzaDetails(pizza.id)}>Detalles</button>
                                    <button className="btn btn-outline-danger btn-sm" onClick={() => addToCart(pizza)}>Sumar al Carro de compra</button>
                                </div>
                            </div>
                        </div>
                    ))}
