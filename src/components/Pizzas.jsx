                    ...
                    <div key={pizza.id} className="">
                        <div className="card d-flex flex-row m-4">
                            ...
                            <div className="card-body">
                                ...
                                <button className="btn btn-outline-success btn-sm" onClick={() => goToGallery()}>Volver al inicio</button>
                                <button className="btn btn-outline-danger btn-sm" onClick={() => addToCart(pizza)}>Agregar pizza a la compra</button>
                            </div>
                        </div>
                    </div>
                </div>
